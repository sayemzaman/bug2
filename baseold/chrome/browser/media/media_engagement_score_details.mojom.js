...
(function() {
  ...
  MediaEngagementScoreDetails.prototype.initDefaults_ = function() {
    ...
    this.audioContextPlaybacks = 0;
    this.mediaElementPlaybacks = 0;
  };
  ...
  MediaEngagementScoreDetails.encodedSize = codec.kStructHeaderSize + 56;
  ...
  MediaEngagementScoreDetails.decode = function(decoder) {
    ...
    val.audioContextPlaybacks = decoder.decodeStruct(codec.Int32);
    val.mediaElementPlaybacks = decoder.decodeStruct(codec.Int32);
    return val;
  };
  ...
  MediaEngagementScoreDetails.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Int32, val.audioContextPlaybacks);
    encoder.encodeStruct(codec.Int32, val.mediaElementPlaybacks);
  };
