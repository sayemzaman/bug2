...
(function() {
  ...
  UsbInternalsPageHandler_BindUsbDeviceManagerInterface_Params.validate = function(messageValidator, offset) {
    ...
    // validate UsbInternalsPageHandler_BindUsbDeviceManagerInterface_Params.request
  ...
  UsbInternalsPageHandler_BindTestInterface_Params.validate = function(messageValidator, offset) {
    ...
    // validate UsbInternalsPageHandler_BindTestInterface_Params.request
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  UsbInternalsPageHandlerProxy.prototype.bindUsbDeviceManagerInterface = function(request) {
  ...
  UsbInternalsPageHandlerProxy.prototype.bindTestInterface = function(request) {
  ...
  UsbInternalsPageHandlerStub.prototype.bindUsbDeviceManagerInterface = function(request) {
    return this.delegate_ && this.delegate_.bindUsbDeviceManagerInterface && this.delegate_.bindUsbDeviceManagerInterface(request);
  }
  UsbInternalsPageHandlerStub.prototype.bindTestInterface = function(request) {
    return this.delegate_ && this.delegate_.bindTestInterface && this.delegate_.bindTestInterface(request);
  }
  ...
  UsbInternalsPageHandlerStub.prototype.accept = function(message) {
    ...
    case kUsbInternalsPageHandler_BindUsbDeviceManagerInterface_Name:
      ...
      this.bindUsbDeviceManagerInterface(params.request);
      return true;
    case kUsbInternalsPageHandler_BindTestInterface_Name:
      ...
      this.bindTestInterface(params.request);
      return true;
    default:
      return false;
    }
