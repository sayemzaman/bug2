...
(function() {
  ...
  NetworkQualityEstimatorManager_RequestNotifications_Params.prototype.initDefaults_ = function() {
    this.clientPtr = new NetworkQualityEstimatorManagerClientPtr();
  };
  ...
  NetworkQualityEstimatorManager_RequestNotifications_Params.validate = function(messageValidator, offset) {
    ...
    // validate NetworkQualityEstimatorManager_RequestNotifications_Params.clientPtr
  ...
  NetworkQualityEstimatorManager_RequestNotifications_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.clientPtr = decoder.decodeStruct(new codec.Interface(NetworkQualityEstimatorManagerClientPtr));
    return val;
  };
  ...
  NetworkQualityEstimatorManager_RequestNotifications_Params.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStruct(new codec.Interface(NetworkQualityEstimatorManagerClientPtr), val.clientPtr);
  };
  ...
  NetworkQualityEstimatorManagerProxy.prototype.requestNotifications = function(clientPtr) {
  ...
  NetworkQualityEstimatorManagerStub.prototype.requestNotifications = function(clientPtr) {
