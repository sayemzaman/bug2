...
(function() {
  ...
  CompositorFrameMetadata.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 88, geometry$.SizeF, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 112, time$.TimeDelta, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 128, selection$.Selection, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CompositorFrameMetadata.encodedSize = codec.kStructHeaderSize + 136;
  ...
  CompositorFrameMetadata.decode = function(decoder) {
    ...
    val.rootOverflowYHidden = (packed >> 3) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  CompositorFrameMetadata.encode = function(encoder, val) {
    ...
    packed |= (val.rootOverflowYHidden & 1) << 3
