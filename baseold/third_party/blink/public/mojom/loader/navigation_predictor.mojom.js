...
(function() {
  ...
  AnchorElementMetricsHost_ReportAnchorElementMetricsOnLoad_Params.encodedSize = codec.kStructHeaderSize + 8;
  ...
  AnchorElementMetricsHostProxy.prototype.reportAnchorElementMetricsOnLoad = function(metrics) {
  ...
  AnchorElementMetricsHostStub.prototype.reportAnchorElementMetricsOnLoad = function(metrics) {
    return this.delegate_ && this.delegate_.reportAnchorElementMetricsOnLoad && this.delegate_.reportAnchorElementMetricsOnLoad(metrics);
  }
  ...
  AnchorElementMetricsHostStub.prototype.accept = function(message) {
    ...
    case kAnchorElementMetricsHost_ReportAnchorElementMetricsOnLoad_Name:
      ...
      this.reportAnchorElementMetricsOnLoad(params.metrics);
      return true;
    default:
      return false;
    }
