...
(function() {
  ...
  WorkerMainScriptLoadParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, url_loader$.URLLoaderClientEndpoints, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate WorkerMainScriptLoadParams.redirectInfos
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 16, 8, new codec.PointerTo(url_loader$.URLRequestRedirectInfo), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate WorkerMainScriptLoadParams.redirectResponseHeads
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 24, 8, new codec.PointerTo(url_loader$.URLResponseHead), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  WorkerMainScriptLoadParams.encodedSize = codec.kStructHeaderSize + 32;
  ...
  WorkerMainScriptLoadParams.decode = function(decoder) {
    ...
    val.responseHead = decoder.decodeStructPointer(url_loader$.URLResponseHead);
    ...
    val.redirectResponseHeads = decoder.decodeArrayPointer(new codec.PointerTo(url_loader$.URLResponseHead));
    return val;
  };
  ...
  WorkerMainScriptLoadParams.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(url_loader$.URLResponseHead, val.responseHead);
    ...
    encoder.encodeArrayPointer(new codec.PointerTo(url_loader$.URLResponseHead), val.redirectResponseHeads);
  };
